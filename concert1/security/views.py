...
from concert1.helpers import encode_id, decode_id, get_or_abort
from concert1.components import db

#ImportError: cannot import name mail
#from concert1 import mail
...
class RegistrationForm(Form):
    ...
    agree = BooleanField("Do you agree to Sunrider's Terms of Service?", validators = [Required(message="You must agree to use this service")])
...
@login_required
def profile():
    flash("A test flash message from the profile function located in controllers/security.py--i.e., the security blueprint... This Account Profile view, and all other protected views are there.")
    return render_template('security/index.html', content='Account Profile')
